# Operator Quickstart — Community Railway Rolling Stock Manufacturing

Shortest path from clone to a verified local dry-run for **ISIC 3020** (`cloud-itonami-isic-3020`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3020.git
cd cloud-itonami-isic-3020
```
...
- Blueprint governor key: `rolling-stock-manufacturing-governor`
- Likely source path: `rolling_stock.governor.cljc`
